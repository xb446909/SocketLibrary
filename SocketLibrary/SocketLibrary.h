...
extern "C" __declspec(dllimport) int  __stdcall TCPSend(int nID, char* szDstIP, int nDstPort, char* szSendBuf);
extern "C" __declspec(dllimport) int  __stdcall UDPSend(int nID, char* szDstIP, int nDstPort, char* szSendBuf);
...
extern "C" __declspec(dllexport) int __stdcall TCPSend(int nID, char* szDstIP, int nDstPort, char* szSendBuf);
extern "C" __declspec(dllexport) int __stdcall UDPSend(int nID, char* szDstIP, int nDstPort, char* szSendBuf);
